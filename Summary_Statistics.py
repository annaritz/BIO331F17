...
def main():
    edges,nodes = read_edge_file("B331_Group/interactome-flybase.txt") # get graph
    positives = read_id_file("B331_Group/positive-ids.txt",nodes) # get pos set
    negatives = read_id_file("B331_Group/negative-ids.txt",nodes) # get neg set
    ...
    create_separation_plot(separation_nodes_dict,separation_edges_dict)
...
def create_separation_dict(adj_list,positives):
    ...
    separation_nodes_dict = {}
    separation_edges_dict = {}
    nodes = set()
    removal_distance = 1
...
def create_K_AND_plot(degree_histogram, pos_degree_hist,neg_degree_hist):
    ...
    pcc = get_P_correlation_coefficient(pos_degree_hist)
    ...
    pcc = get_P_correlation_coefficient(neg_degree_hist)
